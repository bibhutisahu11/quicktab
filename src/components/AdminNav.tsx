...
const ALL_LINKS = [
  ...
  { href: "/admin/orders",       label: "Orders",       icon: "🧾", roles: ["BILLER"] },
  ...
  { href: "/admin/expenses",     label: "Expenses",     icon: "💰", roles: ["HOTEL_ADMIN", "MANAGER", "BILLER"] },
  ...
  { href: "/admin/credit-book",  label: "Credit Book",  icon: "📒", roles: ["HOTEL_ADMIN", "MANAGER", "BILLER"] },
